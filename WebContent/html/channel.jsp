        ...
        <div class="contentWrapper" style="width:100%;">
        	...
        	<div id="content" runat="server" class="content" style="width:80%; float:right;">
        		...
        		<% String channelname = (String) request.getAttribute("channelname"); %>
              	<h2 class="heading">Channel - <% out.println(channelname); %>  Dashboard</h2>
              	<div>
              		<%	
              			boolean isadmin = (boolean) request.getAttribute("isadmin");
              			if(isadmin){
              				out.println("<form action='adminpage'  method='POST'>  <input name='channelname' type='hidden' value = '" + channelname +"'>");
              				
						    out.println("<button class='btn btn-outline-primary my-2 my-sm-0' id='createchannelid' >Admin page</button>");
						    out.println("</form>");
              			}
						    out.println("<p></p>");
						    
							
						    out.println("<form action='startmeeting'  method='POST'>  <input name='channelname' type='hidden' value = '" + channelname +"'>");
              				
						    out.println("<button class='btn btn-outline-primary my-2 my-sm-0' id='createchannelid' >Meeting</button>");
						    out.println("</form>");
